...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-illq94o.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-illq94o.containers.anotherwebservice.com/
...
```
git clone git@github.com:CherryQuartzio/container-illq94o.git
cd container-illq94o
```
...
```
docker attach container-illq94o
```
